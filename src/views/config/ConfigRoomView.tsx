...
const ConfigRoomView: React.FC<DataProps> = () => {
  const { data } = useConfigRoomContext();
  console.log(data);
            ...
            <div className="container">
              <div className="header-config">
                ...
                <h1 className="header-config-title">
                  {/* <SettingFilled /> */}CẤU HÌNH PHÒNG KHÁM
                </h1>
              </div>
